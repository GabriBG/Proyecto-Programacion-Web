...
class personaController{
    ...
    function __construct(){
        ...
        // MOSTRAR PERSONA
        function index(){
            $dato= $this->model->mostrar("personas","1");
...
function nuevo(){
 ...
 function guardar(){
    ...
    $data= "'".$documento_identidad."','".$nombre."','".$apellido."','".$email."',".$telefono."";
...
function update(){
    ...
    $email= $_REQUEST['email'];
    $telefono= $_REQUEST['telefono'];
    $data= "documento_identidad='".$documento_identidad."',nombre='".$nombre."',apellido='".$apellido."',email='".$email."',telefono=".$telefono."";$condicion= "id=".$id;
...
function eliminar(){
     $id= $_REQUEST['id'];
      $condicion= "id=".$id;$dato= $this->model->eliminar("personas",$condicion);
      header("location: index.php");
    }
